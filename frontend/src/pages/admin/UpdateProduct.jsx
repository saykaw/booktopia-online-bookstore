  ...
  const getSingleProduct = async () => {
    try {
      const { data } = await axios.get(
        `${apiKey}/api/v1/product/single-product/${params.slug}`
      );
  ...
  useEffect(() => {
    ...
    const handleUpdate = async (e) => {
      ...
      try {
        ...
        const { data } = axios.put(`${apiKey}/api/v1/product/update-product/${id}`,productData)
        if (data?.success) {
  ...
  const handleDelete = async () => {
    try {
      ...
      const { data } = await axios.delete(
        `${apiKey}/api/v1/product/delete-product/${id}`
      );
      ...
      <div className="row">
        ...
        <div className="col-md-9">
          ...
          <div className="m-1 w-75">
            ...
            //     (<div className="text-center">
            //     <img
            //       src={`${apiKey}/api/v1/product/product-photo/${id}`}
            //       alt="product_photo"
            //       height={"200px"}
            //       className="img img-responsive"
            //     />
